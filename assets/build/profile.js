...
/***/ "./assets/src/instructors/index.ts":
/*!*****************************************!*\
  !*** ./assets/src/instructors/index.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _instructors_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./instructors.css */ "./assets/src/instructors/instructors.css");
/* harmony import */ var _utils_fetch_icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/fetch-icon */ "./assets/src/utils/fetch-icon.ts");
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  const el = document.querySelector(".profile-instructors-list");
  if (el) {
    initInstructors(el);
  }
  icons.close = await (0,_utils_fetch_icon__WEBPACK_IMPORTED_MODULE_1__.fetchIcon)("close");
});
function initInstructors(parentEl) {
  parentEl.addEventListener("click", handleInstructorButtonClick);
}
function handleInstructorButtonClick(e) {
...
let modal = undefined;
function openInstructorProfile(instructor) {
  console.log(instructor);
  modal = document.createElement("div");
  modal.classList.add("instructor-profile__modal-container");
  modal.innerHTML = modalTemplate(instructor);
  document.body.appendChild(modal);
  modal.querySelector(".instructor-profile__close-button")?.addEventListener("click", () => {
...
const modalTemplate = instructor => `
...
/***/ "./assets/src/instructors/instructors.css":
/*!************************************************!*\
  !*** ./assets/src/instructors/instructors.css ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/src/profile-hero/index.ts":
/*!******************************************!*\
  !*** ./assets/src/profile-hero/index.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_hero_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-hero.css */ "./assets/src/profile-hero/profile-hero.css");


/***/ }),

/***/ "./assets/src/profile-hero/profile-hero.css":
/*!**************************************************!*\
  !*** ./assets/src/profile-hero/profile-hero.css ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/src/utils/fetch-icon.ts":
/*!****************************************!*\
  !*** ./assets/src/utils/fetch-icon.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fetchIcon: () => (/* binding */ fetchIcon)
/* harmony export */ });
async function fetchIcon(slug) {
  return fetch('/wp-content/plugins/jp/assets/' + slug + '.svg').then(response => response.text());
}
...
/* harmony import */ var _profile_hero__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./profile-hero */ "./assets/src/profile-hero/index.ts");
/* harmony import */ var _profile_user_notices__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./profile-user-notices */ "./assets/src/profile-user-notices.ts");
/* harmony import */ var _instructors__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./instructors */ "./assets/src/instructors/index.ts");
/* harmony import */ var _profile_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./profile.css */ "./assets/src/profile.css");
/* harmony import */ var _carousel__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./carousel */ "./assets/src/carousel/index.ts");
...
addEventListener("DOMContentLoaded", () => {
  ...
  sliders.forEach(slider => {
    (0,_carousel__WEBPACK_IMPORTED_MODULE_11__.initCarousel)(slider);
  });
});
})();
