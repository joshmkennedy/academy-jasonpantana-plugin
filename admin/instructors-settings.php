...
function jp_instructor_settings_page_html() {
    ...
    $settings = get_option('jp_instructor_settings', ['heading' => "AiM Experts", "tagline" => "For hands-on help, schedule a one-on-one with an AiM expert."]);
?>
    ...
    <style>
        ...
        .settings-form-option input[type="text"],
